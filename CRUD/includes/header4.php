...
<head>
    ...
    <title>CRUD</title>
        <nav class="flex h-20 text-white items-center">
            ...
            <a href="../index.php" class="hover:text-stone-300 font-bold text-lg"><i class="bi bi-house-fill fs-5"></i></a>
                ...
                <a href="../CRUD_pqrs/index.php" class="hover:text-stone-300 font-bold text-lg">PQRS</a>
            </div>
