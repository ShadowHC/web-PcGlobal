...
<?php 
    ...
    $query = "INSERT INTO usuarios(idRol, nomEmpleado, apeEmpleado, tipoDocEmp, numDocEmp, empEmail, empTelefono) VALUES ('$rol', '$nombre', '$apellido', '$tipoDoc', '$numDoc', '$email', '$tel')";
